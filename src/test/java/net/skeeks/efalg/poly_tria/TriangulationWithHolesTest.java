...
class TriangulationWithHolesTest {
	...
	void test2Holes() {
		...
		List<Triangle> triangles = Arrays
				.asList(new Triangle[] { new Triangle(new Vertex(175, 215), new Vertex(138, 318), new Vertex(257, 299)),
						new Triangle(new Vertex(300, 192), new Vertex(257, 299), new Vertex(175, 215)),
						new Triangle(new Vertex(300, 192), new Vertex(65, 233), new Vertex(175, 215)),
	...
	void test3() {
		...
		List<Triangle> triangles = Arrays
				.asList(new Triangle[] { new Triangle(new Vertex(385, 274), new Vertex(360, 252), new Vertex(413, 252)),
						new Triangle(new Vertex(411, 290), new Vertex(296, 306), new Vertex(460, 306)),
	...
	void test4() {
		...
		List<Triangle> triangles = Arrays
				.asList(new Triangle[] { new Triangle(new Vertex(377, 146), new Vertex(512, 110), new Vertex(380, 80)),
						new Triangle(new Vertex(333, 131), new Vertex(321, 191), new Vertex(414, 164)),
	...
	void test5() {
		...
		List<Triangle> triangles = Arrays
				.asList(new Triangle[] { new Triangle(new Vertex(422, 149), new Vertex(301, 188), new Vertex(293, 180)),
						...
						new Triangle(new Vertex(293, 180), new Vertex(152, 188), new Vertex(301, 188)),
